...
public class EditBubbleTextDialog extends Dialog {
    ...
    private com.example.friendfield.Reels.widget.onEditBubbleText onEditBubbleText;
    private CharSequence charSequence;
    private int start,end;

    public EditBubbleTextDialog(Context context, String oldText, com.example.friendfield.Reels.widget.onEditBubbleText onEditBubbleText) {
