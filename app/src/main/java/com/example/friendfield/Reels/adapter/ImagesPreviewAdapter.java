...
public class ImagesPreviewAdapter extends RecyclerView.Adapter<ImagesPreviewAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        if (imageAnimType == 0) {
            ...
            holder.tv_selected_anim.setText("enlarge");
        } else if (imageAnimType == 2) {
            holder.tv_selected_anim.setText("zoom out");
        } else if (imageAnimType == 3) {
            holder.tv_selected_anim.setText("Swipe left");
        } else if (imageAnimType == 4) {
            holder.tv_selected_anim.setText("Swipe right");
        }
