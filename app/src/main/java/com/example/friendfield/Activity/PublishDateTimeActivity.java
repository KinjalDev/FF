...
public class PublishDateTimeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button_continue.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (txt_select_date.getText().toString().isEmpty()) {
                    txt_select_date.setError("Enter date");
                } else if (txt_select_time.getText().toString().isEmpty()) {
                    txt_select_time.setError("Enter Time");
                } else {
                    System.out.println("chk--->>"+ txt_select_date);
                    Intent intent = new Intent(PublishDateTimeActivity.this, PromotionBillActivity.class);
                    intent.putExtra("date", txt_select_date.getText().toString());
        ...
        timepickerdialog = new TimePickerDialog(PublishDateTimeActivity.this,
                new TimePickerDialog.OnTimeSetListener() {
                    ...
                    public void onTimeSet(TimePicker view, int hourOfDay,
                        ...
                        txt_select_time.setText(hourOfDay + ":" + minute + format);
                    }
