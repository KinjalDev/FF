...
public class ChatUserProfileModel {
    ...
    public Boolean getBusinessProfileRegistered() {
        return isBusinessProfileRegistered;
    }

    public void setBusinessProfileRegistered(Boolean businessProfileRegistered) {
        isBusinessProfileRegistered = businessProfileRegistered;
    }

    public Boolean getPersonalProfileRegistered() {
        return isPersonalProfileRegistered;
    }

    public void setPersonalProfileRegistered(Boolean personalProfileRegistered) {
        isPersonalProfileRegistered = personalProfileRegistered;
    }
