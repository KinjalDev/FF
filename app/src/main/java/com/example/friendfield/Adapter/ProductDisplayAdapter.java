...
public class ProductDisplayAdapter extends RecyclerView.Adapter<ProductDisplayAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        Glide.with(context).load(R.drawable.ic_user_img).into(holder.iv_pro_image);
        ...
        holder.iv_delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                btn_delete.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        FileUtils.DeleteProduct(context, Constans.add_product + "/" + productDetailsModelArrayList.get(position).getId());
                        dialog.dismiss();
