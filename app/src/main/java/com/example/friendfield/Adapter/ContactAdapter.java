...
public class ContactAdapter extends RecyclerView.Adapter<ContactAdapter.MyDataViewHolder> {
    ...
    public ContactAdapter(ContactFragment contactFragment, int[] user_img, ArrayList<String> user_name) {
        this.activity = contactFragment;
...
//        holder.txt_user_name.setText(user_name[position]);
        holder.txt_user_name.setText(user_name.get(position));
//        holder.txt_message.setText(user_name[position]);
